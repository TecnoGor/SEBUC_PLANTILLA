...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2024 a las 07:42:54
...
(13, 'Dora Katiuska', 'Alvarez Crespo', 'Venezolano', 'Femenino', 10805944, 1, '1973-09-29', 1, NULL, '04241821120', 'Discapacidades sensoriales y de la comunicación', 'Si', 3, NULL);
...
--
ALTER TABLE `habitantes`
  MODIFY `id_habitante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

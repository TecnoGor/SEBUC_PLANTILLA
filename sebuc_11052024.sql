...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2024 a las 18:29:20
...
INSERT INTO `habitantes` (`id_habitante`, `nombres`, `apellidos`, `nacionalidad`, `cedula`, `id_edoCivil`, `fecha_nacimiento`, `id_tipoHabitante`, `telefono`, `discapacidad`, `pensionado`, `id_poligonal`, `id_jefeFamilia`) VALUES
...
--
ALTER TABLE `habitantes`
  MODIFY `id_habitante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
